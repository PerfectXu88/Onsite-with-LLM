...
class LLMController(PlannerBase):
    ...
    def get_llm_result(self, observation) -> int:
        ...
        action, response, human_question, fewshot_answer = self.DA.few_shot_decision(
            ...
            driving_intensions="Drive safely and avoid collisions, but do not exceed 33m/s. Stay in the rightmost lane if possible. ",
    ...
    def locate_lane_index(self, real_y: float) -> int:
        # 定义目标列表
        lane_coords = [-3, -7, -11]
